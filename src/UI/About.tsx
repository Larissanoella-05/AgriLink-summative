        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto leading-relaxed">
              Connecting farmers with buyers, fostering sustainable agriculture,
              and building stronger communities across Rwanda.
            </p>
          </motion.div>
                ...
                >
                  <div className="relative group overflow-hidden rounded-3xl shadow-soft-lg hover:shadow-glow-lg transition-all duration-500">
                    <motion.img
                      src={
                        slide.image ||
                        '/placeholder.svg?height=400&width=350&query=agriculture'
                      }
